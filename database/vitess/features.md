...
- **Scaling philosophy** — scale horizontally by adding shards, and vertically within a shard via replication. [Scalability philosophy](https://vitess.io/docs/24.0/overview/scalability-philosophy/) - details: [Scaling philosophy](features/scalability-philosophy.md)
