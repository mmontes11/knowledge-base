...
- **Keyspaces** (`Keyspace`) — the logical, top-level unit of a Vitess deployment; a keyspace can be sharded across many shards. [Keyspace](https://vitess.io/docs/24.0/concepts/keyspace/)
...
- **VTGate** (`vtgate`) — the global gateway/proxy that applications connect to; it parses, routes, and reassembles SQL. [VTGate](https://vitess.io/docs/24.0/concepts/vtgate/)
...
- **vschema / routing rules** — define routing rules (including view routing in v24) that map tables and views to keyspaces and shards. [vschema](https://vitess.io/docs/24.0/concepts/vschema/)
